...
## Source Code
The source code of **BaLu** is in the folder: [BaLu_Plus](https://anonymous.4open.science/r/BaLu-E932/BaLu_Plus);

The implementation of GNN-HSIC is in the folder: [GCN_policy_ma](https://anonymous.4open.science/r/BaLu-E932/GCN_policy_ma);

The implementation of NetDeconf is in the folder: [NetDeconf_main](https://anonymous.4open.science/r/BaLu-E932/NetDeconf_main);

The implementation of SPNet is in the folder: [SPNet-main](https://anonymous.4open.science/r/BaLu-E932/SPNet-main);

Other causal inference methods are implemented in the folder: [OtherMethods](https://anonymous.4open.science/r/BaLu-E932/OtherMethods);

The data impuatation method of GRAPE is in the folder: [GRAPE-imputer](https://anonymous.4open.science/r/BaLu-E932/Data-BaLu);

Other imputation methods are implemented and used in the folder: [Data-BaLu](https://anonymous.4open.science/r/BaLu-E932/Data-BaLu). 
...
We do not offer here all the dataset instances under different missing percentages ($p_{\text{miss}}\in\{0.0, 0.1, 0.3\}$) because of limited space of the repository. But readers can use the code in [Data-BaLu](https://anonymous.4open.science/r/BaLu-E932/Data-BaLu) to create all dataset instances. 
...
## Results
All experimental results are stored in the two folders: [results/results_balu_tuning](https://anonymous.4open.science/r/BaLu-E932/results/results_balu_tuning) for results of our BaLu methods, [results/results_others](https://anonymous.4open.science/r/BaLu-E932/results/results_others) for all other baselines.
