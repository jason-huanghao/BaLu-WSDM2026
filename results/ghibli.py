...
ghibli_palettes = {
	...
	'PonyoMedium':cycler('color', ['#E75B64','#278B9A','#DE7862','#D8AF39','#E8C4A2','#4C413F','#5A6F80']),
	'PonyoDark':cycler('color', ['#262020','#2D3740','#14454C',"#070707",'#6E3C31','#6C581D','#746353']),
    ...
    'Self_define1': cycler('color', ['#278B9A','#DE7862','#D8AF39','#E8C4A2','#4C413F','#E75B64','#5A6F80',])
}
