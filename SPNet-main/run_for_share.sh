...
python main_hao.py --tr 0.6 --path ./datasets/ --dropout 0.1 --weight_decay 1e-4 --alpha 1e-4 --lr 1e-2 --epochs 200 --extrastr 1 --dataset BlogCatalog \
	 --normy 1 --nin 1 --nout 1 --hidden 100 --clip 100.

python main_hao.py --tr 0.6 --path ./datasets/ --dropout 0.1 --weight_decay 1e-4 --alpha 1e-4 --lr 1e-2 --epochs 200 --extrastr 1 --dataset BlogCatalog \
	 --normy 1 --nin 2 --nout 2 --hidden 100 --clip 100.
